...
def main():
    ...
    light=[
        ('workflow_policy',[py,'tools/ci/workflow_policy.py'],120),('release_identity',[py,'release_identity.py','--verify'],30),('adaptive_resume',[py,'tools/ci/adaptive_resume_gate.py'],30),('repository_migration',[py,'tools/ci/repository_migration_gate.py'],60),('retired_test_equivalence',[py,'tools/ci/retired_test_equivalence_gate.py'],60),('dependency_readiness',[py,'tools/ci/dependency_readiness_gate.py'],60),('reproducibility',[py,'tools/ci/reproducibility_gate.py'],60),('renderer_role_responsive',['node','tools/ci/renderer_role_responsive_regression_test.js'],60),('fingerprint_portability',[py,'tools/ci/source_fingerprint_portability_test.py'],30),('documentation_typography',[py,'tools/ci/documentation_typography_gate.py'],30),('version',[py,'version_consistency_test.py'],30),('documentation',[py,'tools/ci/documentation_governance_gate.py'],60),('data_utility',[py,'tools/ci/data_utility_gate.py'],45),('functionality_utility',[py,'tools/ci/functionality_utility_checkpoint_gate.py'],45),('data_health',[py,'tools/ci/data_health_policy_gate.py'],30),('source_health',[py,'tools/ci/source_health_architecture_gate.py'],120),('content',[py,'tools/ci/content_copy_audit_test.py'],60),('renderer',['node','renderer_logic_test.js'],90),
    ]
    medium_go=[
