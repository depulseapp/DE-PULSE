...
**HOST-001..003 remains OPEN / NOT VERIFIED.** Real provider-specific approved legal/data-rights evidence/provenance is still not present/bound for actual providers, and a fresh exact-head Fast must still reach and pass Go formatting/vet/full unit-package evidence after the portability fix. Test rights bundles are fixtures only and are not legal evidence.
