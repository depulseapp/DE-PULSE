...
for f in ['persistence_repository.go','persistence_backend_sqlite.go','persistence_backend_fallback.go','runtime_load_profile.go','runtime_observability.go','runtime_slo.go','workload_controller.go','runtime_degradation.go','v17_0_persistence_test.go','runtime_degradation_regression_test.go']:
