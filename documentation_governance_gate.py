...
for term in [f'DE.PULSE v{version}',f'Current Stable baseline:** {previous}','No Execution Boundary','Adaptive Build Process v2','Data Utility','v18','v19','v20']:
...
if e:
    ...
    for x in e: print(' -',x)
    sys.exit(1)
print(f'G16 Documentation Governance: PASS · v{version} {channel} current · immediate Stable {previous} · v18 provenance anchor {stable} preserved · one-H1 hierarchy · inherited roadmap/learning evidence retained')
